export const profile = {
  ...
  aboutBio: [
    ...
    "Beyond work I ship products I care about — FinSight AI (a CrewAI multi-agent financial document analyser), AgenticFlow (a visual DAG orchestration platform), and platforms like CloudOps Hub and JobSight AI. I believe in full-stack ownership: from the first API design to the post-mortem.",
  ],
  location: "Bengaluru, India",
  email: "shubhpersonalok@gmail.com",
  phone: "+91-8303031741",
  version: "v2.0.4",
  socials: {
    github: "https://github.com/shubh2020cs157",
    linkedin: "https://www.linkedin.com/in/shubh23/",
  },
  currentFocus: {
    label: "CURRENT_FOCUS",
    lines: [
      "// Azure API Gateway + Functions",
      "// Agentic AI pipelines (LangGraph)",
