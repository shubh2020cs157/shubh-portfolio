...
export const projects: Project[] = [
  ...
  },
  {
    id: "agentforge",
    title: "AgentForge",
    tagline: "Enterprise AI Agent Builder Platform",
    category: "ai",
  ...
  },
  {
    id: "linguanest",
    title: "LinguaNest",
    tagline: "French Language Learning Platform",
    category: "fullstack",
    categoryLabel: "EdTech & Freelance",
    badges: ["FULL-STACK", "REAL-TIME", "PAYMENTS"],
    description:
      "Freelance full-stack EdTech platform for French language learning — students discover certified tutors, book 1:1 sessions, attend live video classes, and communicate in real time. Built the Next.js frontend and a Spring Boot microservice handling auth, scheduling, Razorpay payments, and session management, backed by PostgreSQL with Liquibase-managed migrations.",
    highlights: [
      "End-to-end session booking — tutor discovery, time-slot scheduling, Razorpay payment, video class (Daily.co + Zoom integration), and post-session feedback in a single seamless flow.",
      "STOMP WebSocket layer for instant payment confirmations and enrolment notifications — students get real-time feedback at the critical payment moment without any polling.",
      "CometChat SDK integration for persistent real-time messaging between students and tutors — unread badges, notification handling, and session-linked conversation threads.",
      "Spring Boot backend with OAuth2 (Google + LinkedIn), Spring Security, Liquibase DB migrations, and WireMock-backed integration tests covering auth, bookings, payments, and feedback contracts.",
      "OAuth profile sync on sign-up auto-populates tutor profiles (name, photo, credentials) — reducing onboarding friction and improving listing quality from day one.",
    ],
